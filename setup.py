...
FRAMEWORKS_REQUIREMENTS = {
    FrameworkKeys.PYTORCH: os.path.join("pytorch", "requirements.txt"),
    # FrameworkKeys.PYTORCH_LIGHTNING: os.path.join("pytorch_lightning", "requirements.txt"),
    # FrameworkKeys.TENSORFLOW: os.path.join("tensorflow", "requirements.txt"),
    # FrameworkKeys.TENSORFLOW_KERAS: os.path.join("tensorflow_keras", "requirements.txt")
}
